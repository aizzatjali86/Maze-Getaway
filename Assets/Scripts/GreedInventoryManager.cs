...
public class GreedInventoryManager : MonoBehaviour
{
    public Text points;
    ...
    void Start()
    {
        ...
        coinItem = Wallet.GetItem("greedCoin");
        fuelItem = Inventory.main.GetItem("greedFuel");
        car1Item = Inventory.main.GetItem("greedCar1");
        car2Item = Inventory.main.GetItem("greedCar2");
        car3Item = Inventory.main.GetItem("greedCar3");
        car4Item = Inventory.main.GetItem("greedCar4");
        ...
        points.text = coinItem.quantity.ToString() + " RG";
        ...
        {
            car1.text = "PURCHASE: " + car1price.ToString() + "RG";
        ...
        {
            car2.text = "PURCHASE: " + car2price.ToString() + "RG";
        ...
        {
            car3.text = "PURCHASE: " + car3price.ToString() + "RG";
        ...
        {
            car4.text = "PURCHASE: " + car4price.ToString() + "RG";
            car4Button.interactable = true;
        }

        CheckLevel();

        if (!PlayerPrefs.HasKey("GreedPlayerCar"))
        {
            PlayerPrefs.SetInt("GreedPlayerCar", 0);
        }

        playerCar = PlayerPrefs.GetInt("GreedPlayerCar");
    }
    ...
    private void Update()
    {
        ...
        if (PlayerPrefs.GetInt("GreedPlayerCar") == 0)
        {
        ...
        {
            if (PlayerPrefs.GetInt("GreedPlayerCar") == 1)
            {
        ...
        {
            if (PlayerPrefs.GetInt("GreedPlayerCar") == 2)
            {
        ...
        {
            if (PlayerPrefs.GetInt("GreedPlayerCar") == 3)
            {
        ...
        fuelText.text = fuelItem.quantity.ToString() + "/" + maxFuel.ToString();
    }
    ...
    public void Refuel()
    {
        //Debug.Log(fuelItem.quantity + "/" + maxFuel);
        if (coinItem.quantity >= 200 && fuelItem.quantity < maxFuel)
        {
            if (fuelItem.quantity <= maxFuel - 10)
            {
                fuelItem.quantity += 10;
            }
            else if (fuelItem.quantity > maxFuel - 10 || fuelItem.quantity < maxFuel)
            {
                fuelItem.quantity = maxFuel;
            }
            coinItem.quantity -= 200;
        }
        Save();
    }
    ...
    public void PurchaseItem()
    {
        ...
        int price = 0;
        if (item == "greedCar1") price = car1price;
        else if (item == "greedCar2") price = car2price;
        else if (item == "greedCar3") price = car3price;
        else if (item == "greedCar4") price = car4price;
        else if (item == "greedLevel2") price = level2price;
        else if (item == "greedLevel3") price = level3price;
        else if (item == "greedLevel4") price = level4price;
    ...
    public void ChooseCar(int item)
    {
        ...
        PlayerPrefs.SetInt("GreedPlayerCar", item);
    }

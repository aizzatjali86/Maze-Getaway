...
public class Vungle
{
	...
	private const string PLUGIN_VERSION = "6.5.3.0";
	private const string IOS_SDK_VERSION = "6.5.3";
	private const string WIN_SDK_VERSION = "6.5.2";
	private const string ANDROID_SDK_VERSION = "6.5.3";
